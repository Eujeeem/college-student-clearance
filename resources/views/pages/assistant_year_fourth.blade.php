...
@section('title')
    Assistant Incharge - Home Forth Year
@endsection
...
<a href="{{route('assistant_incharge_home_forth')}}"  class="btn text-primary"style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px; background-color: #ccc;"><strong>4TH YEAR</strong></a>
