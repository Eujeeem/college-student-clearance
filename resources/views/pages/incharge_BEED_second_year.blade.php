...
<a href="{{route('incharge_BEED')}}"  class="btn btn-light text-dark "style="width:100%; border-radius:0; font-size:20px; box-shadow:0px 0px"><strong>BEED</strong></a>
...
<a href="{{route('incharge_BEED_second_year')}}"  class="btn text-primary"style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px; background-color: #ccc"><strong>2nd YEAR</strong></a>
