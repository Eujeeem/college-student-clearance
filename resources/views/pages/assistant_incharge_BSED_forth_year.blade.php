...
@section('title')
Assistant Incharge - BSED Forth Year
@endsection
...
<a href="{{route('assistant_incharge_BSED_second_year')}}"  class="btn btn-primary text-white "style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px ">2nd YEAR</a>
...
<a href="{{route('assistant_incharge_BSED_forth_year')}}"  class="btn text-primary"style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px; background-color: #ccc"><strong>4TH YEAR</strong></a>
