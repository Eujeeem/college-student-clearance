...
@section('title')
    Assistant Incharge - BSHM Second Year
@endsection
...
<a href="{{route('assistant_incharge_BSHM_second_year')}}"  class="btn text-primary"style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px; background-color: #ccc"><strong>2nd YEAR</strong></a>
...
<a href="{{route('assistant_incharge_BSHM')}}"  class="btn btn-primary text-white"style="width:100px; border-radius: 5px 5px 0px 0px; box-shadow:0px 0px;">All Year</a>
