...
@section('title')
Assistant Incharge - BSBA First Year
@endsection
...
<a href="{{route('assistant_incharge_BSBA')}}"  class="btn btn-light text-dark"style="width:100%; border-radius:0; font-size:20px; box-shadow:0px 0px"><strong>BSBA</strong></a>
...
<a href="{{route('assistant_incharge')}}"  class="btn btn-primary text-dark "style="width:100%; border-radius:0; font-size:20px; box-shadow:0px 0px">ALL</a>  
</div>  
</nav>
...
<div class="button">
<a href="{{route('assistant_incharge_BSBA_first_year')}}"  class="btn btn-primary text-white "style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px ">1ST YEAR</a>
<a href="{{route('assistant_incharge_BSBA_second_year')}}"  class="btn btn-primary text-white "style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px ">2nd YEAR</a>
<a href="{{route('assistant_incharge_BSBA_third_year')}}"  class="btn text-primary"style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px; background-color: #ccc "><strong>3RD YEAR</strong></a>
<a href="{{route('assistant_incharge_BSBA_forth_year')}}"  class="btn btn-primary text-white "style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px ">4TH YEAR</a>
<a href="{{route('assistant_incharge_BSBA')}}"  class="btn btn-primary text-white"style="width:100px; border-radius: 5px 5px 0px 0px; box-shadow:0px 0px; ">All Year</a>
...
<form  name="statusForm" method="POST" onsubmit="return validateForm()" class="incharge-form" required>
    ...
    @foreach ($show as $lists)  
      ...
      @if ($lists->course_name == 'Bachelor of Science in Business Administration')   
