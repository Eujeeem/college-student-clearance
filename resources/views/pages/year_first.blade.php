...
<div class="button">
<a href="{{route('year_first')}}"  class="btn text-primary "style="width:90px; border-radius: 5px 5px 0px 0px; box-shadow:0px 0px; background-color: #ccc "><strong>1st year</strong></a>
