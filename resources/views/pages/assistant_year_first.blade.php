...
@section('title')
    Assistant Incharge - Home First Year
@endsection
...
<div class="button">
<a href="{{route('assistant_incharge_home_first')}}"  class="btn text-primary "style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px; background-color: #ccc; "><strong>1ST YEAR</strong></a>
