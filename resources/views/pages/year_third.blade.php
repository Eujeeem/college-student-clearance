...
<a href="{{route('year_first')}}"  class="btn btn-primary text-white"style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px ">2ND YEAR</a>
<a href="{{route('year_second')}}"  class="btn text-primary "style="width:90px; border-radius: 5px 5px 0px 0px; box-shadow:0px 0px; background-color: #ccc "><strong>3RD YEAR</strong></a>
...
<a href="{{route('year_all')}}"  class="btn btn-primary text-white "style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px">All Year</a>
