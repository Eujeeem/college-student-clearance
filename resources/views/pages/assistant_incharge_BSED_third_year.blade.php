...
@section('title')
Assistant Incharge - BSED Third Year
@endsection
...
<a href="{{route('assistant_incharge_BSED_third_year')}}"  class="btn text-primary"style="width:130px; border-radius: 5px 5px 0px 0px;box-shadow:0px 0px; background-color: #ccc"><strong>3RD YEAR</strong></a>
